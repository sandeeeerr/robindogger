<header x-data="{ open: false, darkMode: localStorage.getItem('theme') === 'dark' }" class="fixed top-0 right-0 left-0 z-50 text-black bg-transparent dark:bg-black dark:text-white">
  <x-container>
